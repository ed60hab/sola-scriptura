...
async def generate_response_with_retry(system_prompt, user_prompt, model_name="models/gemini-2.0-flash"):
    try:
...
@app.get("/health")
async def health():
    return {"status": "ok", "index": INDEX_NAME, "version": "2.1-final"}
